  ...
  return (
    <Tailwind>
      <Html className="font-sans bg-gray-100">
        <Head />
        <Preview>Thank you for your order from Snow Bite Candy!</Preview>
        <Body className="bg-white my-10 mx-auto w-full max-w-2xl">
          ...
          <Container className="p-6">
            ...
            <Text className="text-center text-gray-600 mt-2">
              We're processing your order and will email you when it ships.
            </Text>
          </Container>
          ...
          <Container className="px-6">
            ...
            <Section className="mt-8">
              ...
              <Row className="border-t border-gray-200 mt-4 text-gray-800 font-bold">
                ...
                <Column className="w-1/2 text-right">
                  <Text>{formatPrice(
                    new BigNumber(order.total.toString())
                      .plus(order.tax_total.toString())
                      .toNumber()
                  )}</Text>
                </Column>
              </Row>
          ...
          <Section className="bg-gray-50 p-6 mt-10">
            <Text className="text-center text-gray-500 text-sm">
              If you have any questions, reply to this email or contact our support team at support@snowbitecandy.com
            </Text>
            <Text className="text-center text-gray-500 text-sm">
              Order Token: {order.id}
            </Text>
            <Text className="text-center text-gray-400 text-xs mt-4">
              © {new Date().getFullYear()} Snow Bite Candy. All rights reserved.
            </Text>
          </Section>
        </Body>
      </Html>
